...
from alpha_vantage.timeseries import TimeSeries      #FOR FETCHING STOCK DATA FROM ALPHA VANTAGE API

print("All libraries loaded")

config = {
    "alpha_vantage": {
        "key": "N2D1KYB158XO1ZAK", # Claim your free API key here: https://www.alphavantage.co/support/#api-key
        "symbol": "AMZN", #NVDA , AMZN , MSFT
        "outputsize": "full",
...
# ---------------- REGRESSION ACCURACY ----------------
true_prices = scaler.inverse_transform(data_y_val)
pred_prices = scaler.inverse_transform(predicted_val)
